...
export default function Desicion() {
    return (
        <div className="col-span-3 col-start-2 row-start-4 w-full border border-white/20 bg-white/5 backdrop-blur-md rounded-xl p-6 flex flex-col items-center justify-center shadow-lg transition-all">
